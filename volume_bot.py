...
SURGE_RATIO = 3.0       # recent volume must be 3x baseline per hour
MIN_RECENT_BETS = 5     # need at least 5 bets in surge window
RECENT_HOURS = 2        # surge window
BASELINE_HOURS = 22     # baseline window
MIN_NET_FLOW_MANA = 100 # net directional flow must exceed 100 Mana
