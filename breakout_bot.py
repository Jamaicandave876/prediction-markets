...
BASELINE_BETS = 20      # how many older bets define the "range"
BREAKOUT_BETS = 10      # how many recent bets define the "breakout"
MAX_RANGE_PP = 5.0       # baseline must be within this range (stable)
MIN_BREAKOUT_PP = 6.0    # breakout must move this much
