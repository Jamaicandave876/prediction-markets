...
WHALE_THRESHOLD = 100  # Mana — any single bet above this is a "whale"
LOOKBACK_HOURS = 12    # care about recent whale activity
MIN_PROB_MOVE = 1.0    # whale bet must have moved the market at least 1pp
