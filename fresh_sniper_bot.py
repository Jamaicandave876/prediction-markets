...
MIN_BETS = 10          # need enough early bets
MIN_MOVE_PP = 15       # price must have moved 15pp from open
MAX_AGE_HR = 24        # market must be < 24 hours old
MIN_AGE_HR = 2         # at least 2 hours old (not just noise)
MIN_POOL = 200         # lower threshold for new markets
